...
namespace GotIt.MSSQL.Migrations
{
    ...
    [Migration("20200606133944_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GotIt.MSSQL.Models.MessagesEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GotIt.MSSQL.Models.ObjectColorEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("_ObjectId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("_ObjectId");

                    b.ToTable("ObjectColors");
                });
            ...
            modelBuilder.Entity("GotIt.MSSQL.Models.ObjectColorEntity", b =>
                {
                    b.HasOne("GotIt.MSSQL.Models.ObjectEntity", "_Object")
                        .WithMany("Colors")
                        .HasForeignKey("_ObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
